...
public class TopRated extends Fragment {
    ...
    private static final String TOPRATED_ELEMENTS_KEY   = "recycler_elements";
    ...
    public void onSaveInstanceState(@NonNull Bundle outState) {
        ...
        outState.putSerializable(TOPRATED_ELEMENTS_KEY,movies);
    }
        ...
        Thread thread = new Thread(new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    response = requestHandler.get(GlobalVariables.URL_HIGH_RATE+ GlobalVariables.MOVIE_API_KEY);
